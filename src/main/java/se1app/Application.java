...
public class Application {
    ...
    public void insertTestData() {
        CustomerRepository.createCustomer("Horst", "Müller", "thehorst_64@gmail.com", "Berliner Tor", "3", "20099", "Hamburg", "Germany", true);
        CustomerRepository.createCustomer("Anna", "Smith", "a.smith@outlook.uk", "Berliner Tor", "3", "20099", "Hamburg", "Germany", true);
        CustomerRepository.createCustomer("Marlene", "Schulze", "ms83@bremen-online.de", "Berliner Tor", "3", "20099", "Hamburg", "Germany", true);
        CustomerRepository.createCustomer("Anton", "Smirnov", "asmi-89@inbox.ru", "Berliner Tor", "3", "20099", "Hamburg", "Germany", true);
        ...
        EditSpaceUseCase.addRoom("background1.jpeg", 1);

        SpaceRepository.createSpace("Das Hammer Hart", CustomerRepository.getCustomerById(2));
        EditSpaceUseCase.addRoom("background2.jpeg", 2);
        EditSpaceUseCase.addRoom("background3.jpeg", 1);


        SpaceRepository.createSpace("Das Bonner Loch", CustomerRepository.getCustomerById(2));
        EditSpaceUseCase.addRoom("background2.jpeg", 3);
        EditSpaceUseCase.addRoom("background4.jpeg", 3);
    ...
    public static void main(String[] args) {
        ...
        SpaceRepository.printSpaceTable();
        RoomRepository.printRoomTable();
