...
public class CustomerRepository {
    ...
    public static Customer createCustomer(String firstName, String lastName, String emailAddress, String street, String houseNumber, String postalCode, String town, String country, boolean isOwner) {
        try {
            var customer = new Customer(firstName, lastName, emailAddress, street, houseNumber, postalCode, town, country, isOwner);
